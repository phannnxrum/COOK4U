const DishTypeCard = ({ dishType, imageUrl, number }) => {
    return (
        <div className="flex flex-col items-center justify-center w-[292px] w-auto h-[300px] gap-[16px] p-[16px] rounded-[16px] border border-[#E8E8E8] shadow-md hover:shadow-lg cursor-pointer">
